...
const Webnar = () => {
  return (
    ...
    <section className='  bg-[#12141D] md:py-32 py-10 '>
         <div className='md:max-w-[80rem] px-10 grid grid-cols-1 md:grid-cols-2 justify-center items-center mx-auto md:px-36 mt-8 '>
            <div className=''>
            ...
            <div className='flex flex-col  gap-10'>
                <h1 className='md:text-[52px] text-[45px] leading-[40px] md:leading-[60px] mt-10 md:mt-0  text-[#F7EA68] font-bold'>Trouble-free new webinar software</h1>
                ...
                <div className='flex gap-4'>
                    ...
                    <h1 className='text-[18px] md:text-[20px] leading-[28px] text-white font-bold '>Suitable for use on any device</h1>
                </div>
                <p className='text-[14px] md:text-[16px] leading-[24px] font-normal opacity-[0.8] text-[#FFF]' >A social media strategy is a summary of everything you plan to do and hope to achieve on social media.</p>
            </div>
         </div>

         <div className='md:max-w-[80rem] mx-auto grid grid-cols-1 md:grid-cols-2 justify-center items-center px-10 md:px-36 mt-16  '>
           
            <div className='flex flex-col gap-10'>
                <h1 className='md:text-[52px] text-[45px] leading-[40px] md:leading-[60px] text-[#F7EA68] font-bold'>Trouble-free new webinar software</h1>
            ...
            <div className=' mt-10 md:mt-24  mb-4'>
                <Image src="/images/jason-goodman-fznQW-kn5VU-unsplash (1) 1.svg" alt='jsaon' width={300} height={300} className='rounded-lg ml-20 md:ml-28'/>
            </div>
         </div>
